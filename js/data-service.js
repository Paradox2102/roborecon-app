      ...
      .then(function(matchDataSnapshot) {
        ...
        matchDataSnapshot.forEach(function(matchSnapshot) {
          ...
          matches.push({ 
            ...
            blue_alliance_0: match.alliances.blue.team_keys[0],
            blue_alliance_1: match.alliances.blue.team_keys[1],
            blue_alliance_2: match.alliances.blue.team_keys[2],
            blue_score: match.alliances.blue.score || 0,
            red_alliance_0: match.alliances.red.team_keys[0],
            red_alliance_1: match.alliances.red.team_keys[1],
            red_alliance_2: match.alliances.red.team_keys[2],
